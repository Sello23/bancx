...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ProblemDetail handleOverpayment(OverpaymentException ex) {
        return createProblemDetail(HttpStatus.CONFLICT, "Overpayment Error", ex.getMessage(), "overpayment-detected");
    }
